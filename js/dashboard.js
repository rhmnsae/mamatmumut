...
const Dashboard = {
    ...
    renderProductDetail(id) {
        ...
        if (categoryEl) {
            categoryEl.textContent = product.category || 'Tanpa Kategori';
            categoryEl.style.display = product.category ? 'inline-block' : 'none';
        }
    ...
    renderRecentProducts() {
        ...
        const products = Storage.getProducts().slice(0, 5);
